...
<div class="col-xs-12">  
              <div class="box">
                ...
                <?php 
                    if ($rows['proses']=='0'){
                      echo "<a style='margin:0px 3px' class='btn btn-primary btn-sm' title='Proses Data' href='".base_url()."administrator/proses_penjualan/$rows[id_penjualan]/4' onclick=\"return confirm('Apa anda yakin untuk ubah status jadi Proses dan stok Reseller (Pembeli) akan otomatis bertambah sesuai dengan orderannya ini?')\"><span class='glyphicon glyphicon-star-empty'></span> Proses Pembelian</a>";
                      ...
                      echo "<a style='margin:0px 3px' class='btn btn-primary btn-sm' title='Konfirmasi Proses  Data' href='".base_url()."administrator/proses_penjualan/$rows[id_penjualan]/1' onclick=\"return confirm('Apa anda yakin untuk ubah status jadi Proses dan stok Reseller (Pembeli) akan otomatis bertambah sesuai dengan orderannya ini?')\"><span class='glyphicon glyphicon-star text-yellow'></span> Proses Pembelian</a>";
                    }
                  ?>
              </div>