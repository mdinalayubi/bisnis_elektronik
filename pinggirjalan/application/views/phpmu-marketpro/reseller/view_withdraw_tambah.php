      ...
      <?php include "menu-members.php"; ?>
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 ">
          ...
          echo "<div class='form-group row' style='margin-bottom:5px'>
                ...
                <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Nominal (Rp)</b></label>
                  <div class='col-sm-10'>
                ...
                if (config('withdraw_fee')>0){
                  ...
                  <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Withdraw Fee</b></label>
                    <div class='col-sm-10'>
