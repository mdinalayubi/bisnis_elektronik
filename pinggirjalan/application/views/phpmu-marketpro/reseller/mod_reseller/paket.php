                ...
                <?php 
                    ...
                    foreach ($cek_paket->result_array() as $rowp) {
                      if ($rowp['status']=='Y'){
                        ...
                        untuk Durasi aktif paket <b>$rowp[durasi] Hari</b>, Silahkan melakukan Pembayaran Tepat <b style='color:#000; text-decoration:underline'>Rp ".rupiah($rowp['harga']+$rowp['id_reseller_paket'])."</b><hr>";
                              $noo = 1;
